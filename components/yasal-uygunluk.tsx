  ...
  return (
    <main className="flex-1 p-8 app-bg min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="card p-4 mb-6"><div className="search-input"><input type="text" placeholder="Yasal metin ara..." value={search} onChange={e => setSearch(e.target.value)} /><Search /></div></div>
